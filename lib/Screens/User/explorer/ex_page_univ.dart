...
class ExPageUniv extends StatefulWidget {
  final Universite univ;
  ExPageUniv({super.key, required this.univ});

  @override
  State<ExPageUniv> createState() => _ExPageUnivState();
}

class _ExPageUnivState extends State<ExPageUniv> {
