...
class OptionPage extends StatefulWidget {
  ...
  final Option opt;
  OptionPage({super.key, required this.univ, required this.opt});

  @override
  State<OptionPage> createState() => _UnivPageState();
}

class _UnivPageState extends State<OptionPage> {
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Container(
                  child: CustomText(
                    "Les filières que composent cette l'option ${widget.opt.nom}",
                  ),
                ),
                const SizedBox(
                  height: 10,
